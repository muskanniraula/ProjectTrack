<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Resources.aspx.cs" Inherits="Database_Coursework.Resources" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="Resources.aspx">Resources</a>
                        </li>
        ...
        <div class="container">
            ...
            <div class="grid-container">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="RESOURCEID" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AVAILABLE" SortExpression="RESOURCEAVAILABILITY">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" 
                                    Text='<%# Eval("RESOURCEAVAILABILITY").ToString() == "Yes" ? "Yes" : "No" %>'
                                    CssClass='<%# Eval("RESOURCEAVAILABILITY").ToString() == "Yes" ? "resource-available" : "resource-unavailable" %>'
                                    style="padding: 3px 8px; border-radius: 4px;">
                                </asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlAvailabilityEdit" runat="server" SelectedValue='<%# Bind("RESOURCEAVAILABILITY") %>' CssClass="form-control">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                InsertCommand="INSERT INTO &quot;RESOURCES&quot; (&quot;RESOURCEID&quot;, &quot;TASKID&quot;, &quot;RESOURCENAME&quot;, &quot;RESOURCEAVAILABILITY&quot;) VALUES (:RESOURCEID, :TASKID, :RESOURCENAME, :RESOURCEAVAILABILITY)" 
                ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
                SelectCommand="SELECT &quot;RESOURCEID&quot;, &quot;TASKID&quot;, &quot;RESOURCENAME&quot;, &quot;RESOURCEAVAILABILITY&quot; FROM &quot;RESOURCES&quot;" 
                UpdateCommand="UPDATE &quot;RESOURCES&quot; SET &quot;TASKID&quot; = :TASKID, &quot;RESOURCENAME&quot; = :RESOURCENAME, &quot;RESOURCEAVAILABILITY&quot; = :RESOURCEAVAILABILITY WHERE &quot;RESOURCEID&quot; = :RESOURCEID">
                <DeleteParameters>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="insertModalLabel">Add New Resource</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="form-label">RESOURCEID:</label>
                                <asp:TextBox ID="txtResourceID" runat="server" CssClass="form-control" />
                            </div>
                            <div class="form-group">
                                <label class="form-label">TASKID:</label>
                                <asp:DropDownList ID="ddlTaskID" runat="server" DataSourceID="SqlDataSource2" 
                                    DataTextField="TASKNAME" DataValueField="TASKID" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label class="form-label">RESOURCENAME:</label>
                                <asp:TextBox ID="txtResourceName" runat="server" CssClass="form-control" />
                            </div>
                            <div class="form-group">
                                <label class="form-label">AVAILABLE:</label>
                                <asp:DropDownList ID="ddlResourceAvailability" runat="server" CssClass="form-control">
                                    <asp:ListItem>Yes</asp:ListItem>
                                    <asp:ListItem>No</asp:ListItem>
                                </asp:DropDownList>
                            </div>
    ...
    <script runat="server">
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                decimal resourceId = decimal.Parse(txtResourceID.Text);
                decimal taskId = decimal.Parse(ddlTaskID.SelectedValue);
                string resourceName = txtResourceName.Text;
                string resourceAvailability = ddlResourceAvailability.SelectedValue;

                // Create parameters
                SqlDataSource1.InsertParameters["RESOURCEID"].DefaultValue = resourceId.ToString();
                SqlDataSource1.InsertParameters["TASKID"].DefaultValue = taskId.ToString();
                SqlDataSource1.InsertParameters["RESOURCENAME"].DefaultValue = resourceName;
                SqlDataSource1.InsertParameters["RESOURCEAVAILABILITY"].DefaultValue = resourceAvailability;
                ...
                ddlResourceAvailability.SelectedIndex = 0;
            ...
            catch (Exception ex)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "showError", 
                    $"alert('Error inserting resource: {ex.Message}');", true);
            }
        }
    </script>
</body>
