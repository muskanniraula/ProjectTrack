<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplexForm(UsersProjects).aspx.cs" Inherits="Database_Coursework.ComplexForm_UsersProjects_" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h2 class="page-title">User Projects</h2>
            <div class="dropdown-container">
                <label for="DropDownList1" class="form-label">Select User:</label>
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="USERNAME" DataValueField="USERID" CssClass="form-control form-select">
                </asp:DropDownList>
            </div>

            <div class="grid-container">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="USERID,PROJECTID" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered table-hover">
                    <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT u.UserID, u.UserName, u.UserEmail, u.UserContact, u.UserRole, p.ProjectID, p.ProjectName, p.ProjectStartDate, p.ProjectDueDate, p.ProjectStatus FROM Users u JOIN ProjectsUsers pu ON u.UserID = pu.UserID JOIN Projects p ON pu.ProductID = p.ProjectID WHERE u.UserID = :userID">
                <SelectParameters>
