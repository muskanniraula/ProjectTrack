<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="Database_Coursework.Projects" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="Projects.aspx">Projects</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="grid-container">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PROJECTID" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:BoundField DataField="PROJECTSTARTDATE" HeaderText="START DATE" SortExpression="PROJECTSTARTDATE" DataFormatString="{0:yyyy-MM-dd}" />
                        <asp:BoundField DataField="PROJECTDUEDATE" HeaderText="DUE DATE" SortExpression="PROJECTDUEDATE" DataFormatString="{0:yyyy-MM-dd}" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                InsertCommand="INSERT INTO &quot;PROJECTS&quot; (&quot;PROJECTID&quot;, &quot;PROJECTNAME&quot;, &quot;PROJECTSTARTDATE&quot;, &quot;PROJECTDUEDATE&quot;, &quot;PROJECTSTATUS&quot;) VALUES (:PROJECTID, :PROJECTNAME, :PROJECTSTARTDATE, :PROJECTDUEDATE, :PROJECTSTATUS)" 
                ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
                SelectCommand="SELECT &quot;PROJECTID&quot;, &quot;PROJECTNAME&quot;, &quot;PROJECTSTARTDATE&quot;, &quot;PROJECTDUEDATE&quot;, &quot;PROJECTSTATUS&quot; FROM &quot;PROJECTS&quot;" 
                UpdateCommand="UPDATE &quot;PROJECTS&quot; SET &quot;PROJECTNAME&quot; = :PROJECTNAME, &quot;PROJECTSTARTDATE&quot; = :PROJECTSTARTDATE, &quot;PROJECTDUEDATE&quot; = :PROJECTDUEDATE, &quot;PROJECTSTATUS&quot; = :PROJECTSTATUS WHERE &quot;PROJECTID&quot; = :PROJECTID">
                <DeleteParameters>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="insertModalLabel">Add New Project</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtProjectStartDate" runat="server" CssClass="form-control" TextMode="Date" />
                            </div>
                            <div class="form-group">
                                <label class="form-label">PROJECTDUEDATE:</label>
                                <asp:TextBox ID="txtProjectDueDate" runat="server" CssClass="form-control" TextMode="Date" />
                            </div>
                            <div class="form-group">
    ...
    <script runat="server">
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                decimal projectId = decimal.Parse(txtProjectID.Text);
                string projectName = txtProjectName.Text;
                DateTime projectStartDate = DateTime.Parse(txtProjectStartDate.Text);
                DateTime projectDueDate = DateTime.Parse(txtProjectDueDate.Text);
                string projectStatus = ddlProjectStatus.SelectedValue;

                // Create parameters
                SqlDataSource1.InsertParameters["PROJECTID"].DefaultValue = projectId.ToString();
                SqlDataSource1.InsertParameters["PROJECTNAME"].DefaultValue = projectName;
                SqlDataSource1.InsertParameters["PROJECTSTARTDATE"].DefaultValue = projectStartDate.ToString("yyyy-MM-dd");
                SqlDataSource1.InsertParameters["PROJECTDUEDATE"].DefaultValue = projectDueDate.ToString("yyyy-MM-dd");
                SqlDataSource1.InsertParameters["PROJECTSTATUS"].DefaultValue = projectStatus;
            ...
            catch (Exception ex)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "showError", 
                    $"alert('Error inserting project: {ex.Message}');", true);
            }
        }
    </script>
</body>
